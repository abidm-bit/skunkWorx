...
public class thePrindle {
    public static void main(String[] args) {
        ...
        println("print the array in order");
        for (int i=0;i<arr1.length;i++){
            System.out.print(arr1[i] + " ");
        }

System.out.println("\n");
        println("print the array in reverse");
        for(int i=arr1.length-1;i>=0;i--){System.out.print(arr1[i] + " ");}

System.out.println("\n");
        println("print the array in order, loop thru");
        for(int a:arr1){
            System.out.print(a + " ");
        }
System.out.println("\n");
        LinkedList<Integer> r2 = new LinkedList<>(List.of(0,1,1,2,3,5,8,13,21));
        println("print the linkedlist in order m1");
        for(int i = 0;i<r2.size();i++){
            System.out.print(r2.get(i)+ " ");
        }
System.out.println("\n");
        println("print the linkedlist in order m2, loop thru");
        for(Integer d2:r2){
            System.out.print(d2 + " ");
        }
System.out.println("\n");
        println("print the linkedlist in order m3, Iterator");
...
System.out.println("\n");
        println("print the linkedlist in reverse m1");
        for(int i=r2.size()-1;i>=0;i--){
            System.out.print(r2.get(i)+ " ");
        }
System.out.println("\n");
        println("print the linkedlist in reverse m2, Iterator");
        Iterator<Integer> tarriffs = r2.descendingIterator();
        while(tarriffs.hasNext()){
            System.out.print(tarriffs.next()+" ");
        }

        println("how many points will this spike take");
        println(r2.get(6)+" points");
        println("the last # b4 we break this down is "+ r2.getLast());
System.out.println("\n");        r2.add(34);
        println("post adding a number, r2 is now");
        for(Integer d2:r2){
            System.out.print(d2 + " ");
        }
